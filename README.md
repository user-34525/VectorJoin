...
- clone [nsg](https://github.com/user-34525/nsg) and set it up (this is our slightly modified nsg implementation that also classifies each query into in-distribution and out-of-distribution)
